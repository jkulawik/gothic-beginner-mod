...
instance MENU_ITEM_TALENT_5(C_MENU_ITEM_DEF) { posx = STAT_B_X3;posy = STAT_TAL_Y +  6*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
...
//instance MENU_ITEM_TALENT_12(C_MENU_ITEM_DEF)  { posx = STAT_B_X3;posy = STAT_TAL_Y + 7*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
...
instance MENU_ITEM_TALENT_15(C_MENU_ITEM_DEF)  { posx = STAT_B_X3;posy = STAT_TAL_Y + 10*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
...
INSTANCE MENU_ITEM_NEWTALENTS_HEADING(C_MENU_ITEM_DEF)
{
...
// ------ Test skill 1 ------ // Talent 19
INSTANCE MENU_ITEM_TALENT_19_TITLE(C_MENU_ITEM_DEF)  { posx = STAT_B_X1;posy = STAT_TAL_Y + 15*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
instance MENU_ITEM_TALENT_19_SKILL(C_MENU_ITEM_DEF)  { posx = STAT_B_X3;posy = STAT_TAL_Y + 15*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };

// ------ Test skill 2 ------ // Talent 20
INSTANCE MENU_ITEM_TALENT_20_TITLE(C_MENU_ITEM_DEF)  { posx = STAT_B_X1;posy = STAT_TAL_Y + 16*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
instance MENU_ITEM_TALENT_20_SKILL(C_MENU_ITEM_DEF)  { posx = STAT_B_X2;posy = STAT_TAL_Y + 16*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
...
instance MENU_ITEM_TALENT_10(C_MENU_ITEM_DEF)  { posx = STAT_B_X3;posy = STAT_TAL_Y + 17*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
